...
The  
%\emph{International Systems of Units} 
...
\begin{table}[ht]
\caption{Fundamental quantities of the International System} % title of Table
\centering % used for centering table
\begin{tabular}{l l  c} % centered columns (3 columns)
\hline\hline %inserts double horizontal lines
Dimension & Unit\ & Symbol\  \\ [0.5ex] % inserts table 
%heading
\hline % inserts single horizontal line
length & metre &   \si{\metre} \\ % inserting body of the table
mass         & kilogram &  \si{\kilogram}  \\
time        & second & \si{\second}  \\
electric current & ampere & \si{\ampere}  \\
temperature & kelvin & \si{\kelvin}  \\ [1ex] % [1ex] adds vertical space
quantity & mole & \si{\mole}  \\ [1ex] % [1ex] adds vertical space
luminous intensity & candela & \si{\candela}  \\ [1ex] % [1ex] adds vertical space
\hline %inserts single line
\end{tabular}
\label{table:dimensions} % is used to refer this table in the text
\end{table}
...
\begin{table}[ht]
\caption{Standard prefixes for the SI units of measure} % title of Table
\centering % used for centering table
\begin{tabular}{l l  l} % centered columns (3 columns)
\hline\hline %inserts double horizontal lines
Prefixes  & Symbol & Factor  \\ [0.5ex] % inserts table 
%heading
\hline % inserts single horizontal line
exa &  \si{\exa} & $10^{18}$  \\ % inserting body of the table
peta         & \si{\peta} & $10^{15}$  \\
tera        & \si{\tera} & $10^{12}$ \\
giga & \si{\giga} & $10^9$ \\
mega & \si{\mega} & $10^6$  \\ [1ex] % [1ex] adds vertical space
kilo & \si{\kilo} & $10^3$ \\ [1ex] % [1ex] adds vertical space
\hline %inserts single line
milli & \si{\milli} & $10^{-3}$  \\ % inserting body of the table
micro         & \si{\micro} & $10^{-6}$  \\
nano        & \si{\nano}  & $10^{-9}$  \\
pico  & \si{\pico}  & $10^{-12}$  \\
femto & \si{\femto}  & $10^{-15}$  \\ [1ex] % [1ex] adds vertical space
atto & \si{\atto}  & $10^{-18}$ \\ [1ex] % [1ex] adds vertical space
\hline %inserts single line
\end{tabular}
\label{table:unit} % is used to refer this table in the text
\end{table}
